...
///
/// Returns [Right(unit)] on success. Returns [Left(Failure)] if the file
/// download fails. [PlatformException] from [XcsoarSafService] is **not**
/// caught — it propagates to the caller, matching the existing task-install
